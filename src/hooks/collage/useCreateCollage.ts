...
import { CreateCollageDTO } from "@/features/collage/collage.types";
import { fileService } from "@/features/file/file.service";
import { useMutation, useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";

// Hook'ga kiriladigan ma'lumot — file va name
...
export function useCreateCollage() {
	...
	return useMutation({
		...
		onSuccess: () => {
			...
			toast.success("Fakultet muvaffaqiyatli qo'shildi", { position: "bottom-right" });
		},
