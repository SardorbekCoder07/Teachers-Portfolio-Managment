...
export function NavVerticalLayout({ data, className }: Props) {
	...
	return (
		<nav
			...
			className={cn(
				"fixed inset-y-0 left-0 flex-col h-full bg-background dark:bg-[#141414] border-r border-solid dark:border-[#8C8C8C] z-nav transition-[width] duration-300 ease-in-out",
				className,
			)}
			style={{
				width: navWidth,
